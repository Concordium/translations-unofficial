...
Для установки приложения Concordium ID на iOS необходимо установить приложение Apple TestFlight, которое используется для распространения бета-версий приложений iOS.
