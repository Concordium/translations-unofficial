...
Modüller ayrıca ``name`` komutu kullanılarak da isimlendirilebilinir. ``9eb82a01d96453dbf793acebca0ce25c617f6176bf7a564846240c9a68b15fd2`` referans numaralı modülü ``some_deployed_module`` olarak isimlendirmek için aşağıdaki komut çalıştırılır:
